        ...
        <div class="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div class="lg:w-1/2">
                ...
                <div class="flex gap-4 my-4">
                    ...
                    <a href="https://github.com/JeroenBolhuis" target="_blank" class="bg-neutral-800 hover:bg-neutral-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-300 flex items-center gap-2">
                    ...
                    <a href="https://www.linkedin.com/in/jeroen-bolhuis" target="_blank" class="bg-neutral-800 hover:bg-neutral-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-300 flex items-center gap-2">
