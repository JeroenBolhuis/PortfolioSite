        ...
        <div class="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div class="lg:w-1/2">
                ...
                <div class="flex gap-4 my-4">
                    ...
                    <a href="https://github.com/JeroenBolhuis" aria-label="GitHub" target="_blank" class="bg-neutral-800 hover:bg-neutral-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-300 flex items-center gap-2 hover:scale-105">
                    ...
                    <a href="https://www.linkedin.com/in/jeroen-bolhuis" aria-label="LinkedIn" target="_blank" class="bg-neutral-800 hover:bg-neutral-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-300 flex items-center gap-2 hover:scale-105">
            ...
            <div class="lg:w-1/2 overflow-hidden">
                <div class="macbook-container relative mx-auto max-w-full group">
                    <div class="macbook-screen absolute inset-0 overflow-hidden" style="top: 7%; left: 1.75%; right: 4.7%; bottom: 7.55%;">
                        <img class="w-full h-full object-cover rounded-sm" fetchpriority="high" src="{{ asset('images/Photo_JeroenBolhuis.webp') }}" alt="{{ __('Photo of Jeroen Bolhuis') }}"></img>
                    ...
                    <img class="w-full h-full" fetchpriority="high" src="{{ asset('images/macbook.svg') }}" alt="{{ __('Macbook Frame') }}" />
                </div>
            </div>
        </div>
    </div>
