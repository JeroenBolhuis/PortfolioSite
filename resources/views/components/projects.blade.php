        ...
        <div class="masonry-grid columns-1 lg:columns-2 gap-8 px-4 md:px-20 lg:px-40 max-w-screen-xl mx-auto">
            @foreach ($projects as $project)
                <div class="break-inside-avoid mb-8">
                    <div class="bg-neutral-900 border-2 border-purple-400/15 rounded-2xl overflow-hidden" data-aos="fade-up">
                        <!-- Image Section -->
                            ...
                            @if(isset($project['technologies']))
                                <div class="mt-6 flex flex-wrap gap-2">
                                    @foreach($project['technologies'] as $tech)
                                        <span class="px-3 py-1 bg-white/[0.05] rounded-full text-sm text-gray-300">
                                            {{ $tech }}
                                        </span>
                                    @endforeach
                                </div>
                                ...
                                <div class="mt-6 flex flex-wrap gap-4">
                                    @if(isset($project['link']))
                                        <a href="{{ $project['link'] }}" target="_blank" rel="noopener noreferrer" 
                                           class="inline-flex items-center px-4 py-2 bg-white/[0.05] hover:bg-white/[0.1] rounded-lg text-white transition-colors">
