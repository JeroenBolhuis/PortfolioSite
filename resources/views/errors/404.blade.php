...
<div class="min-h-screen py-12 flex items-center justify-center relative overflow-hidden">
    <div class="absolute inset-0 bg-gradient-to-br from-navi/10 via-transparent to-ink/5 opacity-70"></div>

    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-2xl mx-auto text-center">
            <h1 class="text-8xl lg:text-9xl font-bold text-navi mb-8">
                404
            </h1>
            ...
            <a href="/" class="bg-navi text-lift font-semibold py-3 px-8 rounded-lg transition duration-300 hover:scale-105">
                {{ __('Back to Home') }}
            </a>
        </div>
    </div>
