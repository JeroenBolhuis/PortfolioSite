...
<div class="container pt-20 md:pt-36 mx-auto flex flex-wrap flex-col md:flex-row items-center">
  ...
  <div class="relative flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
    ...
    <p class="leading-normal text-base md:text-2xl mb-8 text-center md:text-left">
      Zeg vaarwel tegen losse papieren, handmatige processen en klantverwarring. Automatiseer uw werk en verhoog de productiviteit met een op maat gemaakte website.
    </p>
  ...
  <div class="w-full xl:w-3/5 p-12 overflow-hidden">
    <a href="portfolio">
      <img class="mx-auto w-full md:w-4/5 transform -rotate-6 transition hover:scale-105 duration-700 ease-in-out hover:rotate-6" src="{{ asset('storage/macbook.svg') }}" alt="Macbook Image" />
    </a>
  </div>
@endsection
