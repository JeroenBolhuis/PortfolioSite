...
<head>
    ...
    <title>@yield('title', 'EfficiënC')</title>
...
<body class="flex flex-col text-indigo-400" style="background-image: url('{{ asset('storage/header.png') }}');background-attachment: fixed;">
    <nav class="bg-black fixed w-full z-20 top-0 start-0 border-b border-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="https://flowbite.com/docs/images/logo.svg" class="h-8" alt="Flowbite Logo">
                <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">EfficiënC</span>
            </a>
            ...
            <div class="w-full md:block md:w-auto peer-checked:block hidden">
                <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent">
                    @foreach([
                        ...
                        ['name' => 'Portfolio', 'url' => '/portfolio', 'active' => request()->is('portfolio')]
                    ] as $item)
                        <li>
    ...
    <footer class="bg-gray-800 text-white py-4 mt-auto">
        <div class="container mx-auto text-center">
            <p>&copy; {{ date('Y') }} EfficiënC. All rights reserved.</p>
        </div>
    </footer>
