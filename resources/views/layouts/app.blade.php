...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Archivo:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Azeret+Mono:wght@400;500&display=swap" rel="stylesheet">
            ...
            <div class="flex flex-wrap items-center justify-between py-3">
                ...
                <div class="md:block w-auto hidden">
                    <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
                        <li>
                            <a href="#hero" class="block py-2 px-3 text-ink hover:text-ember transition-colors duration-300">{{ __('Home') }}</a>
                        </li>
                        <li>
                            <a href="#about" class="block py-2 px-3 text-ink hover:text-ember transition-colors duration-300">{{ __('About') }}</a>
                        </li>
                        <li>
                            <a href="#contact" class="block py-2 px-3 text-ink hover:text-ember transition-colors duration-300">{{ __('Contact') }}</a>
                        </li>
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex flex-wrap gap-6 text-sm">
                        <a href="#hero" class="hover:text-ember transition-colors duration-300">{{ __('Home') }}</a>
                    </div>
                </div>
                <div class="flex space-x-6">
                    <a href="https://github.com/JeroenBolhuis" target="_blank" rel="noopener noreferrer nofollow" class="hover:text-ember transition-colors duration-300">
                    ...
                    <a href="https://www.linkedin.com/in/jeroen-bolhuis" target="_blank" rel="noopener noreferrer nofollow" class="hover:text-ember transition-colors duration-300">
                        <span class="sr-only">LinkedIn</span>
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                    </a>
                    <a href="https://www.x.com/_jeroentjeb_" target="_blank" rel="noopener noreferrer nofollow" class="hover:text-ember transition-colors duration-300">
                    ...
                    <a href="https://www.instagram.com/jeroenb4" target="_blank" rel="noopener noreferrer nofollow" class="hover:text-ember transition-colors duration-300">
